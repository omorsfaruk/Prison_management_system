    ...
    <div class="row">
      <div class="col-md-6">
        <div class="from-area-1">
          <form class="" action="{{url('store-visitor')}}" method="post">
            @csrf
              <input name="name" value="" type="text" placeholder="Full Name">
              <input name="location" value="" type="text" placeholder="Current Address">
              <input name="par_location" value="" type="text" placeholder="Permanent Address">
              <input name="gender" value="" type="text" placeholder="Gender">
      ...
      <div class="col-md-6">
        <div class="from-area-2">
            ...
            <input name="relative" value="" type="text" placeholder="Relation with Prisoner">
            <input name="phone" value="" type="text" placeholder="Phone">
            <input name="time" value="" type="time" placeholder="Visit Time">
