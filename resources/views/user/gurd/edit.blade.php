    ...
    <div class="row">
      <div class="col-md-6">
        <div class="from-area-1">
          <form class="" action="{{url('update/'.$edit->id)}}" method="post">
            @csrf
              <input value="{{$edit->fname}}" name="fname" type="text" placeholder="First Name">
              <input value="{{$edit->lname}}" name="lname" type="text" placeholder="Last Name">
              <input value="{{$edit->phone}}" name="phone" type="text" placeholder="Phone">
      ...
      <div class="col-md-6">
        <div class="from-area-2">
            ...
            <input value="{{$edit->date}}" name="date" type="date" placeholder="Date">
            <input value="{{$edit->time}}" name="time" type="time" placeholder="Duty Time">
            <input value="{{$edit->id}}" name="id" type="text" placeholder="ID">
